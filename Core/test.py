...
chrome_install_location = "/home/grurexx/Downloads/chrome-linux64"
chromedriver_install_location = "/home/grurexx/Downloads/chromedriver-linux64/chromedriver"
chrome_headless_shell_install_location = "/home/grurexx/Downloads/chrome-headless-shell-linux64"
...
def get_driver(headless=False):
    ...
    options.add_argument("user-data-dir=/home/grurexx/.config/google-chrome-for-testing/Default")
    if headless:
    ...
    return Chrome(service=BraveService(ChromeDriverManager(chrome_type=ChromeType.BRAVE).install()), options=options)

def wait_for_element_to_load(xpath_: str, wait_time=10):
    try:
