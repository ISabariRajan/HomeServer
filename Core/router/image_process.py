...
async def get_original_image(request: Request, response: Response):
  ...
  image_path = join(logos_dir, "thaya-thread-logo-crop.png")
  shared_obj.company_logo = img_processor.open_rgba_image(image_path)
...
async def get_updated_image(request: Request, response: Response):
  ...
  shared_obj.updated_image = gen_img_processor.process_image(shared_obj.original_image, "AAA-000000")
